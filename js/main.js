    ...
    "subtypes": [
      ...
      },
      {
        ...
        "resolutions": [
          ...
          {
            "id": 1620254398112,
            "text": "Android: \nSet the hidden element's android:importantForAccessibility attribute to No. Consider providing an android:contentDescription attribute to the \"Deuda\" text element specifying the information to be announced and heading level. (i.e. \"Novedades 10.0.19 carousel, slide 1 of 4, Deuda heading level 2\")\n\niOS:\nSet the isAccessibilityElement property to false on the hidden element. Consider setting the accessibilityLabel property to the \"Deuda\" text element specifying the information to the announced and heading level. (i.e. \"Novedades 10.0.19 carousel, slide 1 of 4, Deuda heading level 2\")\n",
            "code": "",
          ...
          {
            "id": 1620312082475,
            "text": "Ensure removing the hidden elements from the screen or hide them from Screen Readers users by setting isAccessibilityElement property to false. Consider setting the accessibilityLabel property to the component specifying the information to the announced and heading level. (i.e. \"Novedades 10.0.19 carousel, slide 1 of 4, Deuda heading level 2\")\nhttps://developer.apple.com/documentation/objectivec/nsobject/1615141-isaccessibilityelement\n\nAndroid:\nFirst, ensure removing the hidden components from the screen or hide them from Screen Readers users by setting the attribute android:importantForAccessibility to No or using android:visibility=\"gone\". Second, consider providing an android:contentDescription attribute to the component specifying the information to the announced and heading level. (i.e. \"Novedades 10.0.19 carousel, slide 1 of 4, Deuda heading level 2\")\n\n",
            "code": "",
          ...
          {
            "id": 1620312189434,
            "text": "Ensure not moving the focus to the elements that are hidden or are not supposed to be focused until previous information is entered. \nConsider hiding the elements using android:visibility=\"gone\" taking into account that when using “gone” it is like removing it from the layout. Apprise hiding from Screen Readers users, the elements that are not supposed to be focused until certain conditions are met, by setting the view's attribute android:importantForAccessibility to No. \n\n",
            "code": "",
      ...
      },
      {
        ...
        "resolutions": [
          ...
          {
            "id": 1620320859083,
            "text": "Ensure the visible checkbox receives the accessibility focus and the hidden checkbox is removed from the screen. Consider using the android:importantForAccessibility attribute with a value of Yes on the element. ",
            "code": "",
            "links": "-https://developer.android.com/reference/android/view/View#attr_android:importantForAccessibility",
            "type": "android"
          }
      ...
      },
      {
        ...
        "resolutions": [
          {
            "id": 1620316438788,
            "text": "Consider setting the view's attribute android:importantForAccessiblity to No on the decorative image, avoiding this element from receiving accessibility focus.\n",
            "code": "",
            "links": "-https://developer.android.com/reference/android/view/View#attr_android:importantForAccessibility\n",
            "type": "android"
          },
          {
            "id": 1620411262275,
            "text": "Consider checking if the hidden element is important for the view, if so, appraise making it visible, otherwise remove it from the screen or hide it from Screen Reader by setting the android:importantForAccessibility (isAccessibilityElement in iOS) attribute to No (false for iOS). \n",
            "code": "",
            "links": "-https://developer.android.com/reference/android/view/View#attr_android:importantForAccessibility\n-https://developer.apple.com/documentation/objectivec/nsobject/1615141-isaccessibilityelement\n",
            "type": "android and ios"
          },
    ...
    "subtypes": [
      {
        ...
        "resolutions": [
          ...
          {
            "id": 1625178221982,
            "text": "Consider checking if the elements are important for the view, if so, appraise making them visible, otherwise remove them from the screen or hide it from Screen Reader users. Appraise setting the view's attribute android:importantForAccessiblity to No, avoiding the elements from receiving accessibility focus or use android:visibility=\"gone\" for hiding them\n",
            "code": "",
            "links": "-https://developer.android.com/reference/android/view/View#GONE\n-https://developer.android.com/reference/android/view/View#attr_android:importantForAccessibility\n",
            "type": "android"
          }
